...
class ExpectationMaximizationTestCluster():
    ...
    def run(self):
        ...
        for k in self.clusters:
            ...
            if k == self.targetcluster and self.stats:
                ...
                pd_data.to_csv("wine_em_10cluster.csv", index=False, index_label=False, header=False)
    ...
    def plot(self, ll, homogeneity, completeness, rand, bic, aic):
            ...
            plt.title('Wine EM-Log Probability')
            #plt.show()
            ...
            plt.title('Wine EM-Homogeneity Score')
            #plt.show()
            ...
            plt.title('Wine EM-Completeness Score')
            #plt.show()
