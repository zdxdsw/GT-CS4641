...
def main():
    ...
    model = AdaBoostClassifier(DecisionTreeClassifier(max_depth=2, min_samples_split=3, min_samples_leaf=3),
                             algorithm="SAMME",n_estimators=300, learning_rate=0.6)
    i = 0
    total = 0.0
    training_total = 0.0
    ...
    test_df.to_csv('gbt_submission.csv', columns=header, index=False, header=True)
