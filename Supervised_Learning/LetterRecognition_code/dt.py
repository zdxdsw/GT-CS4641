...
def main():
    ...
    model = tree.DecisionTreeClassifier(criterion='gini', min_impurity_decrease=0.00001)  
    i = 0
    total = 0.0
    training_total = 0.0
    ...
    '''
    Feature importance indicates the importance of the feature in this
    classification problem. The larger the number, the more influence
    a particular feature has on the classification result
    '''
